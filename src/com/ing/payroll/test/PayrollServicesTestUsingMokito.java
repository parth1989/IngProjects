...
public class PayrollServicesTestUsingMokito {
	...
	@Before
	public void setUpTestData() throws SQLException, PayrollServicesDownException {
		...
		Associate associate3 =new Associate( 65440, 12121, "Mayur", "Patil", "ADC", "Trainee", "CYYJUUF887",
